...
const cacheName = 'extraXPfixit11level6Campbell-2020-11-08 23:11:10.556479'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'extraXPfixit11level6Campbell'.length) === 'extraXPfixit11level6Campbell') {
